...
//   // useCompletion returns 'completion' (the AI response) instead of 'messages'
//   const { completion, input, handleInputChange, handleSubmit, isLoading } =
//     useCompletion({
//       api: "/api/chat", // Use your /api/chat route
//     });
...
//   // Hook to capture the source documents when a completion is finished
//   useEffect(() => {
//     // This part is complex because useCompletion doesn't return the 'data' property easily
//     // We will have to rely on the API implementation to handle this.
//     // For now, this code will just display the summary.
//   }, [completion]);

//   // Scroll to the bottom on new completion
//   useEffect(() => {
...
//       <h1 className="text-2xl font-bold mb-6">Legal Document Search</h1>

//       <div className="grow overflow-y-auto space-y-6 pb-6">
//         {/* We just show the single completion text */}
//         {completion && (
//           <div className="text-gray-800 bg-white p-4 rounded-lg shadow-md">
...
//   // Fetch sources from headers after completion
//   useEffect(() => {
//     if (completion && !isLoading) {
//       // Sources are in the response headers, we need to extract them
//       // For now, let's make a separate call to get them
//     }
...
//             {sources.length > 0 && (
//               <div className="mt-4">
//                 <h3 className="font-bold mb-2">Source Documents:</h3>
//                 {sources.map((doc, idx) => (
...
//               <div className="text-gray-500 italic">No relevant documents found.</div>
//             )}
//           </>
//         )}
//         {isLoading && (
//           <div className="p-4">Searching documents...</div>
//         )}
//         <div ref={messagesEndRef} />
//       </div>
...
//     console.log("Submitting search:", input);
//     setLoading(true);
//     setDocuments([]);
//     setError(null);
...
//         {!loading && documents.length === 0 && input && !error && (
...
//         {documents.length > 0 && (
//           <div>
//             <h3 className="font-bold mb-3">Found {documents.length} Documents:</h3>
//             {documents.map((doc) => (
//               <a
//                 key={doc.id}
...
//         {!loading && documents.length === 0 && input && !error && (
//           <div className="text-gray-500">No documents found. Try a different search term.</div>
//         )}
